...
function box1(){
    if (moveent == 0  && box1act == false){
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard) : <b>Ai Turn</b>";
...
function ai(){
  ...
  if(box1act == true && box9act == true && box5act == false){
  ...
  else if(box1oc == 1 && box2oc == 3 && box3oc == 1){
    box2oc = 1;
    document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
     ...
     document.getElementById("box2").style.background ="url(X.png)";
     document.getElementById("box2").style.backgroundSize ="250px 250px";check()}
   else if(box1oc == 3 && box2oc == 1 && box3oc == 1){
      box1oc = 1;
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
       ...
       document.getElementById("box1").style.backgroundSize ="250px 250px";check()}
      ...
      else if(box4oc == 1 && box5oc == 3 && box6oc == 1){
        box5oc = 1;
        document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
         ...
         document.getElementById("box5").style.background ="url(X.png)";
         document.getElementById("box5").style.backgroundSize ="250px 250px";check()}
       else if(box4oc == 3 && box5oc == 1 && box6oc == 1){
          box4oc = 1;
          document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
      ...
      else if(box7oc == 1 && box8oc == 1 && box9oc == 3){
            box9oc = 1;
            document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
          ...
          else if(box7oc == 1 && box8oc == 3 && box9oc == 1){
            box8oc = 1;
            document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
             ...
             document.getElementById("box8").style.background ="url(X.png)";
             document.getElementById("box8").style.backgroundSize ="250px 250px";check()}
           else if(box7oc == 3 && box8oc == 1 && box9oc == 1){
              box7oc = 1;
              document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
        ...
        else if(box1oc == 1 && box4oc == 1 && box7oc == 3){
                box7oc = 1;
                document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
              ...
              else if(box1oc == 1 && box4oc == 3 && box7oc == 1){
                box4oc = 1;
                document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                 ...
                 document.getElementById("box4").style.background ="url(X.png)";
                 document.getElementById("box4").style.backgroundSize ="250px 250px";check()}
               else if(box1oc == 3 && box4oc == 1 && box7oc == 1){
                  box1oc = 1;
                  document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                  ...
                  else if(box2oc == 1 && box5oc == 3 && box8oc == 1){
                    box5oc = 1;
                    document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                     ...
                     document.getElementById("box5").style.background ="url(X.png)";
                     document.getElementById("box5").style.backgroundSize ="250px 250px";check()}
                   else if(box2oc == 3 && box5oc == 1 && box8oc == 1){
                      box2oc = 1;
                      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
        ...
        else if(box3oc == 1 && box6oc == 1 && box9oc == 3){
                        box9oc = 1;
                        document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                      ...
                      else if(box3oc == 1 && box6oc == 3 && box9oc == 1){
                        box6oc = 1;
                        document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                         ...
                         document.getElementById("box6").style.background ="url(X.png)";
                         document.getElementById("box6").style.backgroundSize ="250px 250px";check()}
                       else if(box3oc == 3 && box6oc == 1 && box9oc == 1){
                          box3oc = 1;
                          document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
        ...
        else if(box1oc == 1 && box5oc == 1 && box9oc == 3){
                            box9oc = 1;
                            document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                          ...
                          else if(box1oc == 1 && box5oc == 3 && box9oc == 1){
                            box5oc = 1;
                            document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
                             ...
                             document.getElementById("box5").style.background ="url(X.png)";
                             document.getElementById("box5").style.backgroundSize ="250px 250px";check()}
                           else if(box1oc == 3 && box5oc == 1 && box9oc == 1){
                              box1oc = 1;
                              document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
    ...
    document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
     ...
     document.getElementById("box5").style.background ="url(X.png)";
     document.getElementById("box5").style.backgroundSize ="250px 250px";check()}
   else if(box3oc == 3 && box5oc == 1 && box7oc == 1){
      box3oc = 1;
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Your turn</b> ";
        ...
        if( box4act == true ){ ai()}
          ...
          if( box3act == true ){ ai()}
            ...
            if( box2act == true ){ ai()}
              ...
              document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard) : <b>Your turn</b>";check()
...
diga()
 ...
 if(box1act == true && box2act == true && box3act == true && box4act == true && box5act == true && box6act == true && box7act == true && box8act == true && box9act == true){
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>Tie</b> <button btn btn-success onclick='Reset()'> Reset</button> ";
    }
...
function horizontal(){
  if (box1act == true&& box2act == true && box3act == true){
    if (box1oc == 0 && box2oc == 0 && box3oc == 0 ){
      ...
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>You Win</b> <button btn btn-success onclick='Reset()'> Reset</button> ";
    }
      ...
      document.getElementById("box2").style.backgroundColor = "white";
      document.getElementById("box3").style.backgroundColor = "white";
      document.getElementById("whosemove").innerHTML = "Tic Tac Toe AI (Hard): <b>You Lost</b> <button btn btn-success onclick='Reset()'> Reset</button> ";
